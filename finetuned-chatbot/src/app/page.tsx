...
export default function Dashboard() {
  ...
  // Verify Telegram connection (optional - app works without it)
  const verifyTelegramConnection = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Telegram optional - app works without it
                  ...
                  <>
                    ...
                    <button 
                      ...
                      onClick={() => {
                        ...
                        window.open('https://t.me/budget_sentiel_bot?start=connect', '_blank');
                      }}
